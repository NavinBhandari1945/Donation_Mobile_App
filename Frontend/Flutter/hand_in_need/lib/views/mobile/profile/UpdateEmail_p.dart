...
class Updateemail extends StatefulWidget {
  ...
  const Updateemail({super.key, required this.username, required this.usertype, required this.jwttoken});

  @override
  State<Updateemail> createState() => _UpdateemailState();
}

class _UpdateemailState extends State<Updateemail> with SingleTickerProviderStateMixin {
  ...
  Future<int> UpdateEmail({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return 7; // old email and new email same
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Update Email", style: TextStyle(fontSize: 24, color: Colors.white, fontWeight: FontWeight.bold)),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField("Enter new email", email_cont, shortestval, widthval),
            SizedBox(height: shortestval * 0.05),
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: shortestval * 0.03),
                  _buildTextField("Enter new email", email_cont, shortestval, widthval * 0.65),
                ],
              ),
            ),
