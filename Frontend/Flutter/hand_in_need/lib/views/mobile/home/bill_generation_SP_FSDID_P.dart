...
class _Bill_generation_SP_FD_PState extends State<Bill_generation_SP_FD_P> with SingleTickerProviderStateMixin {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Note: Please send this screenshot of payment to the app's official Email and contact customer support. This payment process was successful by wallet but not saved in storage for future history, so contact us as soon as possible.",
                      style: TextStyle(
