              ...
              onPressed: () async {
                try {
                  ...
                  if (result_select_video_post == 2) {
                    isLoadingCont_video.change_isloadingval(false);
                    Toastget().Toastmsg("Video size exceeds more tahn 2 GB.Fail.");
                    return;
                  }
                  if (result_select_video_post == 3) {
                    isLoadingCont_video.change_isloadingval(false);
                    Toastget().Toastmsg("Invalid video format.Only support .mp4, .mkv, .webm, .3gp, .avi, .mov, .wmv, .ogg");
                    return;
                  }
...
//   final String usertype;
//   final String jwttoken;
//   const InsertcampaignscreenP({super.key,required this.username,required this.usertype,
//     required this.jwttoken});
//   @override
//   State<InsertcampaignscreenP> createState() => _InsertcampaignscreenPState();
// }
//
// class _InsertcampaignscreenPState extends State<InsertcampaignscreenP> {
//
//   final campaign_descriptiion_cont=TextEditingController();
//   final campaign_tittle_cont=TextEditingController();
//   final campaign_postId_cont=TextEditingController();
...
//       (
//       appBar: AppBar(
//         title: Text("Insert Campaign Screen"),
...
//                         [
//
//                           CommonTextField_obs_false_p("Enter the post Id.", "", false, campaign_postId_cont, context),
//                           CommonTextField_obs_false_p("Enter tittle of campaign.", "", false, campaign_tittle_cont, context),
//                           CommonTextField_obs_false_p("Enter description of campaign.", "", false, campaign_descriptiion_cont, context),
//
...
//
//                           CommonButton_loading(label: "Add campaign.",
//                             onPressed:()async
//                             {
//                               try{
//                                 isLoadingCont_add_campaign.change_isloadingval(true);
