...
class _LoginScreenState extends State<LoginScreen>
                    ...
                    children: [
                      ...
                      CommonTextField_obs_false_p(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(
                              color: Colors.grey[500], fontFamily: regular),
                        ),
                      ),
                      SizedBox(height: shortestval * 0.04),
                        ...
                        children: [
                          ...
                          IconButton(
                            onPressed: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => FeedbackScreenP()),
                            ),
      ...
      child: SlideTransition(
        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(
                  horizontal: widthval * 0.1, vertical: heightval * 0.05),
              child: Row(
  ...
  void _login() async {
    try {
      ...
      if (username_cont.text.isEmptyOrNull ||
          passwoord_cont.text.isEmptyOrNull) {
        Toastget()
            .Toastmsg("All fields are mandatory. Fill first and try again.");
        isloading_getx_cont.change_isloadingval(false);
        return;
      }
      int login_rsult = await login_user(
          username: username_cont.text, password: passwoord_cont.text);
      print("Login result");
      print(login_rsult);
      if (login_rsult == 1) {
