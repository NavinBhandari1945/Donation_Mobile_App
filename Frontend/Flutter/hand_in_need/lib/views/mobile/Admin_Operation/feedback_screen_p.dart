...
class Feedback_Screen_Ui extends StatefulWidget {
  ...
  const Feedback_Screen_Ui({super.key, required this.username, required this.usertype, required this.jwttoken});
...
class _Feedback_Screen_UiState extends State<Feedback_Screen_Ui> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Feedback",
          style: TextStyle(fontSize: 24, color: Colors.white, fontWeight: FontWeight.bold, letterSpacing: 1),
        ),
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Center(
                    child: Text(
                      ...
                      style: TextStyle(color: Colors.red, fontSize: shortestval * 0.05),
                    ),
                  );
                } else {
          ...
          children: [
            ...
            Feedback_Info_List.isEmpty
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                childAspectRatio: 1.1, // Adjusted to reduce unnecessary height
              ),
  ...
  Widget _buildEmptyState(double shortestval) {
    return Center(
      child: Padding(
        padding: EdgeInsets.symmetric(vertical: shortestval * 0.1),
        child: Text(
  ...
  Widget _buildFeedbackCard(FeedbackModel feedback, double widthval, double shortestval, bool isPortrait) {
    ...
    return ScaleTransition(
      ...
      child: Card(
        ...
        margin: EdgeInsets.only(bottom: shortestval * 0.02),
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              imageBytes != null
                ...
                child: Image.memory(
                  imageBytes,
                  height: isPortrait ? shortestval * 0.3 : shortestval * 0.2, // Reduced height in landscape
